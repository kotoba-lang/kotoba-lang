...
3. **Incremental cljs host rewire** — landed #122–#132 (… + infer gc/relay/moe/join #131 + overlay runtime/driver + deploy #132); remaining infer plan/engine/rebalance/credits
