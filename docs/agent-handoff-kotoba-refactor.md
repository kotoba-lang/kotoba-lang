...
| W6 murakumo pure-planners **medium+** | **complete through #95** (#61–#95: product-shell KIR for kekkai/token/report/infer.plan/dash/schedule/task + live HMAC/AES) |
...
1. **Expand product-shell oracles** — more verticals beyond kekkai/token/report/infer.plan/dash/schedule/task (#86–#95 pattern: precompiled KIR + host delegate); next engine
...
**Landed 2026-07-28:** product-shell KIR authority for kekkai (#86), token (#88), report (#89), infer.plan (#91), dash.state (#93), schedule (#94), task.plan (#95); live HMAC/AES host adapters (#87).
