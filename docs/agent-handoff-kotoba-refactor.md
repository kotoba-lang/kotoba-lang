...
**R1 progress:** #295 semantics-ssot, #411 pure-product + error codes, #309 T1.2 matrix, compiler#412–#425 T1.3×**28** (if-some/control/bitops + loop + T7.4 10k) + T1.4/T1.5 + T3.1–T3.4 + T7.1 partial + **T7.4** + T9.1–T9.3 + T2.2/T2.4 + T5.4 + T6.1/T6.3 + T7.2/T7.3 + **T10.1–T10.3**.
