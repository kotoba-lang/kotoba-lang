...
| W6 murakumo pure-planners **medium+** | **complete through #89** (#61–#89: pure cores + live HMAC/AES adapters + product-shell KIR for kekkai/token/report) |
...
1. **Expand product-shell oracles** — more verticals beyond kekkai/token/report (#86–#89 pattern: precompiled KIR + host delegate; next: infer/plan)
...
| rebalance + plan + engine + report pure path | murakumo#61–#89 |
