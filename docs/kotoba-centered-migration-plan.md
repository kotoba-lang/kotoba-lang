...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#68** rebalance path + infer.plan partition pure core (`plan-lr-3`/fits + `partition-3-ends` walk). Next: n≠3 plan maps / Delivery 5–8; network/secret caps remain contract-only.
