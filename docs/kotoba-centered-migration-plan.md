...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#82** pure path (incl. host-shell report rows + tunnel parse-digits). Next: Delivery 5–8 / HMAC crypto host; network/secret caps remain contract-only.
