...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#71** rebalance + plan + engine pure path (incl. head-cmd). Next: n≠3 plan maps / report GiB rows / Delivery 5–8; network/secret caps remain contract-only.
