...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#96** pure+adapter path (product-shell KIR through engine + live HMAC/AES). Next: bulk remaining cores / Delivery 5–8 remaining shells; network/secret caps remain contract-only.
