...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#94** pure+adapter path (product-shell KIR: kekkai/token/report/infer.plan/dash/schedule + live HMAC/AES). Next: expand catalog (task/engine/…) / Delivery 5–8 remaining shells; network/secret caps remain contract-only.
