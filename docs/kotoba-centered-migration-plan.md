...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#67** rebalance path + infer.plan partition pure core (`plan-lr-3`/fits). Next: further map folds / Delivery 5–8; network/secret caps remain contract-only.
