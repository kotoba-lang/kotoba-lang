...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#81** pure-planner path (incl. task assign-step-3 + dash cap math). Next: crypto/host shells / Delivery 5–8; network/secret caps remain contract-only.
