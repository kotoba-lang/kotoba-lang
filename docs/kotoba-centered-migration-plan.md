...
**Allowlist pure reference-implemented set complete.** **murakumo#61/#63** map-fold verticals (`largest-remainder-3`, `pool-demand-pack`, `classify-run-flags`). Next: further map folds / Delivery 5–8; network/secret caps remain contract-only.
