...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#98** pure+adapter path (product-shell KIR through engine + secret + live HMAC/AES). Next: bulk remaining cores (fleet/config/credits/overlay/…) / Delivery 5–8 remaining shells; network/secret caps remain contract-only.
