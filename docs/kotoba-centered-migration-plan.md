...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#89** pure+adapter path (live HMAC/AES + kekkai/token/report product-shell KIR authority). Next: expand product-shell catalog (infer/…) / Delivery 5–8 remaining shells; network/secret caps remain contract-only.
