...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#87** pure+adapter path (live HMAC/AES host adapters + kekkai product-shell KIR authority). Next: expand product-shell oracles / Delivery 5–8 remaining shells; network/secret caps remain contract-only.
