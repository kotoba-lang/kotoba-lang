...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#95** pure+adapter path (product-shell KIR: kekkai/token/report/infer.plan/dash/schedule/task + live HMAC/AES). Next: expand catalog (engine/…) / Delivery 5–8 remaining shells; network/secret caps remain contract-only.
