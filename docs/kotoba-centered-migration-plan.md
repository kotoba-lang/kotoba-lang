...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#77** pure-planner path (incl. n=1/2 plan maps + asg-row). Next: variable-arity assign reduce / n>3 partition / Delivery 5–8; network/secret caps remain contract-only.
