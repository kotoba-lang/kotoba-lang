...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#76** pure-planner path (incl. assign-step-2 + task-eligible?). Next: n≠3 plan maps / variable-arity assign reduce / Delivery 5–8; network/secret caps remain contract-only.
