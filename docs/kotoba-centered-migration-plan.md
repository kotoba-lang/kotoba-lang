...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#88** pure+adapter path (live HMAC/AES host adapters + kekkai/token product-shell KIR authority). Next: expand product-shell catalog / Delivery 5–8 remaining shells; network/secret caps remain contract-only.
