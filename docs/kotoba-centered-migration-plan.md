...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#65** rebalance product path (LR/pool/demand folds + placement pure layer). Next: further map folds / Delivery 5–8; network/secret caps remain contract-only.
