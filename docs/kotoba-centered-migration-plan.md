...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#73** rebalance + plan + engine + report + schedule pick pure path. Next: n≠3 plan maps / assign batches / Delivery 5–8; network/secret caps remain contract-only.
