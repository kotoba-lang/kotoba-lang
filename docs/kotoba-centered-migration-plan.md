...
**Allowlist pure reference-implemented set complete.** **murakumo#61** first map-fold product vertical (`largest-remainder-3`). Next: further map folds / Delivery 5–8; network/secret caps remain contract-only.
