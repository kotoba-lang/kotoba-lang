...
**Allowlist pure reference-implemented set complete.** **murakumo#61–#75** pure-planner path (incl. schedule pick + reconcile pick-targets). Next: n≠3 plan maps / assign batches / Delivery 5–8; network/secret caps remain contract-only.
