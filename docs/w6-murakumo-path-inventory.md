...
1. murakumo pure-planner path #61–#73 complete (incl. schedule pick). Remaining: n≠3 node-id plan maps / assign job batches / reconcile-lines multi-join / crypto/host shells.
