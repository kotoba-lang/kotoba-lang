...
1. murakumo pure+adapter path **#61–#132** — cljs dual-source through overlay runtime/driver + deploy and infer gc/relay/moe/join. Remaining: Delivery 5–8 shells / residual PVA / **incremental cljs rewire** (infer plan/engine/rebalance/credits) / network·secret caps contract-only.
