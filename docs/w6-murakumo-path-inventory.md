...
- **2026-07-28 murakumo#89:** **product-shell oracle authority (report)** — `murakumo.report` pure formatters/headers/rows/help delegate to `resources/murakumo/oracle/report_core.kir.edn` via `:report-core` catalog; host keeps reconcile mapcat + Unicode field pad.
