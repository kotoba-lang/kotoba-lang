...
1. murakumo pure-planner path #61–#72 complete for fixed-3 plan/rebalance + engine strings + report GiB/pad. Remaining: n≠3 node-id plan maps / reconcile-lines / command-help / crypto/host shells.
