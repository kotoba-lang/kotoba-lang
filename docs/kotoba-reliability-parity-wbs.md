...
| T8.3 | Network + secret **signed** reference providers (leave pure allowlist alone) | **capability-***, **kotoba-core-contracts**, **tamaki**, **kototama** | **kit EDN signed receipts** provider#36; **Wasm Component signed still open** | T8.1 | XL |
